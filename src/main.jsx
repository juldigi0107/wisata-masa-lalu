...
/* Production visuals are generated WebP. Editable SVG files stay authoring-only and
   are rasterized by scripts/generate-world-raster.mjs before every production build. */
...
/* Visual DNA v6 adds real raster texture/object material over the generated environment art. */
const sceneDetailAssets={
 rumah:'assets/media/cassette.jpg',
 kampung:'assets/media/warung.jpg',
 sekolah:'assets/media/dr-grip.jpg',
 kota:'assets/media/pager.jpg',
 digital:'assets/media/gameboy-color.jpg'
};
for(const [id,path] of Object.entries(sceneDetailAssets)){
 rootStyle.setProperty(`--wml-scene-${id}-detail`,runtimeAsset(path));
}
