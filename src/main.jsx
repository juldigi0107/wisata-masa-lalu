...
import FlagshipRuntimeV8 from "./world/FlagshipRuntimeV8.jsx";
...
/* All public visual surfaces resolve to raster/WebP. SVG files may exist only as
   authoring intermediates and are removed from the production artifact. */
...
createRoot(document.getElementById("root")).render(<React.StrictMode><AppErrorBoundary><WorldExperienceShell/><AmbientRuntimeV4/><PremiumRuntimeV5/><FlagshipRuntimeV8/><EventVisualRuntimeV7/><ObjectLensVisualRuntimeV7/><EasterEggRuntime/></AppErrorBoundary></React.StrictMode>);
