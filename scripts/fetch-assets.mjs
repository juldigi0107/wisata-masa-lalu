...
for (const [target, file, width] of assets) {
  ...
  try {
    const res = await fetch(url, {headers:{'User-Agent':'WisataMasaLalu/1.0 (asset build; GitHub Pages)'}});
...
if (ok === 0) throw new Error('No external visual assets could be fetched.');
